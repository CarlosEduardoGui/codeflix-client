    ...
    <div className='relative h-screen overflow-hidden bg-gradient-to-b lg:h-[140vh]'>
      ...
      <main className='relative pb-24 pl-4 lg:pl-16'>
        ...
        <div className='flex space-x-3'>
          <button className='md:text-xl; flex cursor-pointer items-center gap-x-2 rounded bg-white text-black px-5 py-1.5 text-sm font-semibold '>
            Play
          </button>
          <button className='md:text-xl; flex cursor-pointer items-center gap-x-2 rounded bg-gray-600 text-black px-5 py-1.5 text-sm font-semibold '>
            More info
          </button>
        </div>
      </main>
